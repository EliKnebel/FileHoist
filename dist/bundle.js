...
/***/ function(module, exports, __webpack_require__) {
	...
	var FileHoist = function (_React$Component) {
		_inherits(FileHoist, _React$Component);

		function FileHoist(props) {
			_classCallCheck(this, FileHoist);

			return _possibleConstructorReturn(this, (FileHoist.__proto__ || Object.getPrototypeOf(FileHoist)).call(this, props));
		}

		/** React Component Render */


		_createClass(FileHoist, [{
			key: 'render',
			...
			value: function showDialog() {
				_reactDom2.default.findDOMNode(this.refs.uploadfile).click();
			}
			...
			value: function upload(params) {
				...
				var fileInput = _reactDom2.default.findDOMNode(this.refs.uploadfile);
				...
				request.upload.addEventListener('progress', function (e) {
					...
					if (_this2.props.onUploadProgress) _this2.props.onUploadProgress(loaded, total);
				}, false);

				// add upload complete listener
				request.addEventListener("load", function (event) {
					// clear file input
					_reactDom2.default.findDOMNode(_this2.refs.uploadfile).value = "";
					...
					if (_this2.props.onUploadComplete) _this2.props.onUploadComplete(resp);
				});
			...
			value: function fileSelected() {
				if (this.props.onFileSelection) {
					setTimeout(this.props.onFileSelection(_reactDom2.default.findDOMNode(this.refs.uploadfile).files), 1);
				}
			}
		}]);
	...
	exports.default = FileHoist;


	FileHoist.propTypes = {
		multiple: _react2.default.PropTypes.bool,
		visible: _react2.default.PropTypes.bool,
		uploadMethod: _react2.default.PropTypes.string,
